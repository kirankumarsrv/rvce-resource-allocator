...
INSERT INTO user_roles (user_id, role_id, granted_by) VALUES
    ...
    ('44444444-4444-4444-4444-444444444006', '22222222-2222-2222-2222-222222222001', '44444444-4444-4444-4444-444444444001'),
    ('44444444-4444-4444-4444-444444444007', '22222222-2222-2222-2222-222222222001', '44444444-4444-4444-4444-444444444001'),
    ('44444444-4444-4444-4444-444444444008', '22222222-2222-2222-2222-222222222001', '44444444-4444-4444-4444-444444444001'),
    ('44444444-4444-4444-4444-444444444009', '22222222-2222-2222-2222-222222222001', '44444444-4444-4444-4444-444444444001'),
    ('44444444-4444-4444-4444-444444444010', '22222222-2222-2222-2222-222222222001', '44444444-4444-4444-4444-444444444001'),
    ('44444444-4444-4444-4444-444444444011', '22222222-2222-2222-2222-222222222001', '44444444-4444-4444-4444-444444444001'),
    ('44444444-4444-4444-4444-444444444012', '22222222-2222-2222-2222-222222222001', '44444444-4444-4444-4444-444444444001'),
    ('44444444-4444-4444-4444-444444444013', '22222222-2222-2222-2222-222222222001', '44444444-4444-4444-4444-444444444001'),
...
-- ── Block A: Classrooms ────────────────────────────────────────
('55555555-5555-5555-5555-555500000001','A101','Classroom A101','CLASSROOM',60,NULL,NULL,1,'A','Main Block',
 12.9232100,77.4991200,'From main gate, enter Main Block, Ground floor, first corridor left.',
 '11111111-1111-1111-1111-111111111001'),

('55555555-5555-5555-5555-555500000002','A102','Classroom A102','CLASSROOM',60,NULL,NULL,1,'A','Main Block',
 12.9232100,77.4991500,'From main gate, enter Main Block, Ground floor, second door left.',
 '11111111-1111-1111-1111-111111111001'),

('55555555-5555-5555-5555-555500000003','A201','Classroom A201','CLASSROOM',60,NULL,NULL,2,'A','Main Block',
 12.9232400,77.4991200,'Main Block Block A, take stairs to Floor 1, turn right, third room.',
 '11111111-1111-1111-1111-111111111001'),

('55555555-5555-5555-5555-555500000004','A202','Classroom A202','CLASSROOM',60,NULL,NULL,2,'A','Main Block',
 12.9232400,77.4991500,'Main Block Block A, Floor 1, fourth room on right.',
 '11111111-1111-1111-1111-111111111001'),

('55555555-5555-5555-5555-555500000005','A301','Classroom A301','CLASSROOM',60,NULL,NULL,3,'A','Main Block',
 12.9232700,77.4991200,'Main Block Block A, Floor 2, first room on right.',
 '11111111-1111-1111-1111-111111111002'),

('55555555-5555-5555-5555-555500000006','A302','Classroom A302','CLASSROOM',60,NULL,NULL,3,'A','Main Block',
 12.9232700,77.4991500,'Main Block Block A, Floor 2, second room on right.',
 '11111111-1111-1111-1111-111111111002'),

-- ── Block B: Labs ──────────────────────────────────────────────
('55555555-5555-5555-5555-555500000007','B101','CSE Lab 1','LAB',40,NULL,NULL,1,'B','Main Block',
 12.9233000,77.4993000,'Enter Block B from left corridor, Ground floor, Lab 1 on right.',
 '11111111-1111-1111-1111-111111111001'),

('55555555-5555-5555-5555-555500000008','B102','CSE Lab 2','LAB',40,NULL,NULL,1,'B','Main Block',
 12.9233000,77.4993500,'Block B Ground floor, Lab 2 opposite Lab 1.',
 '11111111-1111-1111-1111-111111111001'),

('55555555-5555-5555-5555-555500000009','B201','ISE Lab 1','LAB',40,NULL,NULL,2,'B','Main Block',
 12.9233300,77.4993000,'Block B Floor 1, ISE Lab 1.',
 '11111111-1111-1111-1111-111111111002'),

('55555555-5555-5555-5555-555500000010','B202','ECE Lab 1','LAB',40,NULL,NULL,2,'B','Main Block',
 12.9233300,77.4993500,'Block B Floor 1, ECE Lab 1.',
 '11111111-1111-1111-1111-111111111003'),

-- ── Block C: Classrooms ────────────────────────────────────────
('55555555-5555-5555-5555-555500000011','C101','Classroom C101','CLASSROOM',70,NULL,NULL,1,'C','New Block',
 12.9234000,77.4995000,'New Block entrance, Ground floor, C-wing first door.',
 '11111111-1111-1111-1111-111111111003'),

('55555555-5555-5555-5555-555500000012','C102','Classroom C102','CLASSROOM',70,NULL,NULL,1,'C','New Block',
 12.9234000,77.4995500,'New Block Ground floor, second door C-wing.',
 '11111111-1111-1111-1111-111111111003'),

('55555555-5555-5555-5555-555500000013','C201','Classroom C201','CLASSROOM',70,NULL,NULL,2,'C','New Block',
 12.9234300,77.4995000,'New Block Floor 1, C-wing first door.',
 '11111111-1111-1111-1111-111111111004'),

('55555555-5555-5555-5555-555500000014','C202','Classroom C202','CLASSROOM',70,NULL,NULL,2,'C','New Block',
 12.9234300,77.4995500,'New Block Floor 1, C-wing second door.',
 '11111111-1111-1111-1111-111111111004'),

('55555555-5555-5555-5555-555500000015','C301','Classroom C301','CLASSROOM',70,NULL,NULL,3,'C','New Block',
 12.9234600,77.4995000,'New Block Floor 2, C-wing first door.',
 '11111111-1111-1111-1111-111111111005'),

-- ── Block D: Exam Halls (bench grid set) ──────────────────────
('55555555-5555-5555-5555-555500000016','D101','Exam Hall D101','EXAM_HALL',120,10,12,1,'D','Examination Block',
 12.9235000,77.4997000,'Examination Block, Ground floor, Hall D101.',
 NULL),

('55555555-5555-5555-5555-555500000017','D102','Exam Hall D102','EXAM_HALL',120,10,12,1,'D','Examination Block',
 12.9235000,77.4997500,'Examination Block, Ground floor, Hall D102.',
 NULL),

('55555555-5555-5555-5555-555500000018','D201','Exam Hall D201','EXAM_HALL',80,8,10,2,'D','Examination Block',
 12.9235300,77.4997000,'Examination Block, Floor 1, Hall D201.',
 NULL),

('55555555-5555-5555-5555-555500000019','D202','Exam Hall D202','EXAM_HALL',80,8,10,2,'D','Examination Block',
 12.9235300,77.4997500,'Examination Block, Floor 1, Hall D202.',
 NULL),

('55555555-5555-5555-5555-555500000020','D301','Exam Hall D301','EXAM_HALL',60,6,10,3,'D','Examination Block',
 12.9235600,77.4997000,'Examination Block, Floor 2, Hall D301.',
 NULL),

-- ── Seminar Halls ──────────────────────────────────────────────
('55555555-5555-5555-5555-555500000021','SH-A','Seminar Hall A','SEMINAR_HALL',150,NULL,NULL,1,'A','Main Block',
 12.9232800,77.4990000,'Main Block, Ground floor, follow signboards to Seminar Hall A.',
 NULL),

('55555555-5555-5555-5555-555500000022','SH-B','Seminar Hall B','SEMINAR_HALL',100,NULL,NULL,2,'B','Main Block',
 12.9233500,77.4993800,'Block B, Floor 1, Seminar Hall B opposite staircase.',
 NULL),

('55555555-5555-5555-5555-555500000023','SH-C','Seminar Hall C','SEMINAR_HALL',80,NULL,NULL,1,'C','New Block',
 12.9234100,77.4996000,'New Block, Ground floor, Seminar Hall C near elevator.',
 NULL),

-- ── Conference Rooms ───────────────────────────────────────────
('55555555-5555-5555-5555-555500000024','CONF-1','Conference Room 1','CONFERENCE_ROOM',20,NULL,NULL,3,'A','Main Block',
 12.9233000,77.4991800,'Block A, Floor 2, Conference Room 1 near HOD office.',
 '11111111-1111-1111-1111-111111111001'),

('55555555-5555-5555-5555-555500000025','CONF-2','Conference Room 2','CONFERENCE_ROOM',20,NULL,NULL,3,'B','Main Block',
 12.9233800,77.4994200,'Block B, Floor 2, Conference Room 2.',
 '11111111-1111-1111-1111-111111111002'),

-- ── More Classrooms ────────────────────────────────────────────
('55555555-5555-5555-5555-555500000026','A401','Classroom A401','CLASSROOM',60,NULL,NULL,4,'A','Main Block',
 12.9233000,77.4991000,'Block A, Floor 3, Room A401.',
 '11111111-1111-1111-1111-111111111001'),

('55555555-5555-5555-5555-555500000027','A402','Classroom A402','CLASSROOM',60,NULL,NULL,4,'A','Main Block',
 12.9233000,77.4991300,'Block A, Floor 3, Room A402.',
 '11111111-1111-1111-1111-111111111002'),

('55555555-5555-5555-5555-555500000028','B301','CSE Lab 3','LAB',40,NULL,NULL,3,'B','Main Block',
 12.9233600,77.4993200,'Block B, Floor 2, CSE Lab 3.',
 '11111111-1111-1111-1111-111111111001'),

('55555555-5555-5555-5555-555500000029','C401','Classroom C401','CLASSROOM',70,NULL,NULL,4,'C','New Block',
 12.9234900,77.4995200,'New Block, Floor 3, Room C401.',
 '11111111-1111-1111-1111-111111111005'),

('55555555-5555-5555-5555-555500000030','D401','Exam Hall D401','EXAM_HALL',100,10,10,4,'D','Examination Block',
...
(1,
 '66666666-6666-6666-6666-666666666001',
 '55555555-5555-5555-5555-555500000003',
 '44444444-4444-4444-4444-444444444004',
...
(2,
 '66666666-6666-6666-6666-666666666001',
 '55555555-5555-5555-5555-555500000004',
 '44444444-4444-4444-4444-444444444004',
 'Computer Science & Engineering',
...
(3,
 '66666666-6666-6666-6666-666666666001',
 '55555555-5555-5555-5555-555500000007',
 '44444444-4444-4444-4444-444444444003',
 'Computer Science & Engineering',
